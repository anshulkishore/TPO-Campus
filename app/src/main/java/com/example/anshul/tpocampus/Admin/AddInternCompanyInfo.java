...
public class AddInternCompanyInfo {

    private String name, profile, cutoff_cpi, stipend, location, reg_deadline, reg_deadline_time, test_date, ppo_provision,
                   cse, it, ece, ee, mech, pie, civil, chem, bio, mca, is_completed, additional_info;


    public AddInternCompanyInfo(String name, String profile, String cutoff_cpi, String stipend, String location, String reg_deadline,
                                String reg_deadline_time, String test_date, String ppo_provision, String cse, String it, String ece, String ee, String mech,
    ...
    public String getReg_deadline_time() {
        return reg_deadline_time;
    }

    public void setReg_deadline_time(String reg_deadline_time) {
        this.reg_deadline_time = reg_deadline_time;
    }
