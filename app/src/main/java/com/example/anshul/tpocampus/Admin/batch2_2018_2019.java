...
public class batch2_2018_2019 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.batch2_2018_2019, container, false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        //Recycler View
        mRecyclerView = (RecyclerView) getActivity().findViewById(R.id.student_list);
...
//
//        sel_stu_editor.putString("student_batch", "pre final year");
//        sel_stu_editor.commit();

        //send a query to database
        mRef = FirebaseDatabase.getInstance().getReference("pre final year").child("users");
