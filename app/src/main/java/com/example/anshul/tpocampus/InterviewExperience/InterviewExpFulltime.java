...
public class InterviewExpFulltime extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Fulltime Interview Experiences");
    ...
    private void prepareData() {
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference("interview_experiences").child("fulltime");
