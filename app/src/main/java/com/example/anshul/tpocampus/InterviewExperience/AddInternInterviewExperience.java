...
public class AddInternInterviewExperience extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_intern_interview_experience);

        setTitle("Add Interview Experience");

        your_name = (EditText) findViewById(R.id.add_your_name);
        comp_name = (EditText) findViewById(R.id.add_company_name);
        int_year = (EditText) findViewById(R.id.add_year);
        int_exp = (EditText) findViewById(R.id.add_intern_exp);
        add_exp = (Button) findViewById(R.id.add_intern_exp_button);
        ...
        add_exp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mDatabase.child("interview_experiences").child("internship").child(c_name + " (" + year + ") by " + name).setValue(interviewExpInfo).
