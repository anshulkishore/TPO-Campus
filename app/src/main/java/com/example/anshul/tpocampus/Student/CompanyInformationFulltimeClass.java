...
/**
 * Created by ANSHUL KISHORE on 13-12-2017.
 */

public class CompanyInformationFulltimeClass {

    String bio, chem, civil, cse, cutoff_cpi, ece, ee, is_completed, it, location, mca, mech, name, pie, ppo_provision,
            profile, reg_deadline, reg_deadline_time, salary, test_date, additional_info;

    public CompanyInformationFulltimeClass(String bio, String chem, String civil, String cse, String cutoff_cpi, String ece, String ee,
                                           String is_completed, String it, String location, String mca, String mech, String name,
                                           String pie, String ppo_provision, String profile, String reg_deadline,
                                           String reg_deadline_time, String salary, String test_date, String additional_info) {
        this.bio = bio;
        this.chem = chem;
        this.civil = civil;
        this.cse = cse;
        ...
        this.name = name;
        this.pie = pie;
        this.ppo_provision = ppo_provision;
    ...
    public CompanyInformationFulltimeClass() {}
    ...
    public String getPpo_provision() {
        return ppo_provision;
    }

    public void setPpo_provision(String ppo_provision) {
        this.ppo_provision = ppo_provision;
    }
